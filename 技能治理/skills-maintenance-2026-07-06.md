# OpenClaw / Hermes Skills 整理报告 — 2026-07-06

- 生成时间：2026-07-06T03:00:36+08:00 / 2026-07-05T19:00:36+00:00
...
- `creative` ⚠️ — （无描述）
  - path: `/root/.hermes/skills/creative`; files: 81; size: 283.6 KiB; mtime: 2026-07-05
- `data-science` ⚠️ — （无描述）
  - path: `/root/.hermes/skills/data-science`; files: 10; size: 49.2 KiB; mtime: 2026-06-28
- `devops` ⚠️ — （无描述）
  - path: `/root/.hermes/skills/devops`; files: 78; size: 364.3 KiB; mtime: 2026-07-05
...
- `note-taking` ⚠️ — （无描述）
  - path: `/root/.hermes/skills/note-taking`; files: 13; size: 46.9 KiB; mtime: 2026-07-05
- `research` ⚠️ — （无描述）
